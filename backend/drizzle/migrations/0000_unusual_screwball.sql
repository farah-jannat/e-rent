...
CREATE TYPE "public"."landlord_plans" AS ENUM('free', 'standard', 'premium');--> statement-breakpoint
CREATE TABLE "flats" (
...
CREATE TABLE "landlords" (
	...
	"phone_number" text,
	"quota_limit" integer DEFAULT 2 NOT NULL,
	"plan" "landlord_plans" DEFAULT 'free' NOT NULL,
...
CREATE TABLE "quotas" (
	...
	CONSTRAINT "quotas_landlord_id_unique" UNIQUE("landlord_id")
);
--> statement-breakpoint
...
ALTER TABLE "quotas" ADD CONSTRAINT "quotas_landlord_id_landlords_id_fk" FOREIGN KEY ("landlord_id") REFERENCES "public"."landlords"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
